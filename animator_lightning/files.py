...
class ProgramState(State):
    ...
    def enter(self, machine):
        ...
        if mixer.voice[0].playing:
            ...
            option_mode_file_name = "/sd/menu_voice_commands/option_mode_entered_black_red.wav"
            if show_demo_unit:
                option_mode_file_name = "/sd/menu_voice_commands/option_mode_entered_left_right.wav"
            wave0 = audiocore.WaveFile(open(option_mode_file_name, "rb"))
